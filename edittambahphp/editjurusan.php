...
if (isset($_POST['update'])) {
    $db->edit_data_jurusan(
        $_POST['kodejurusan'],
        $_POST['namajurusan'],
    );

    echo "<script>alert('Data berhasil diperbarui!'); window.location='datajurusan.php';</script>";
}
?>
...
<html lang="en">
  ...
  <head>
    ...
    <title>AdminSekolah | Form Edit Data Jurusan</title>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Form Edit Data Jurusan</h3></div>
              <div class="col-sm-6">
              ...
              <div class="col-md-6">
                ...
                <div class="card card-primary card-outline mb-4">
                  ...
                  <form action="" method="post">
                    <!--begin::Body-->
                    <div class="card-body">
                      <input type="hidden" name="kodejurusan" value="<?php echo $data['kodejurusan']; ?>">
                      <div class="mb-3">
                        <label for="namajurusan" class="form-label">Jurusan</label>
                        <input type="text" class="form-control" id="namajurusan" name="namajurusan" value="<?php echo $data['namajurusan']; ?>"/>
                      </div>
                    </div>
                    <!--end::Body-->
                    <!--begin::Footer-->
