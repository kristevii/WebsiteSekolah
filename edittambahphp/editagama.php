...
if (isset($_POST['update'])) {
    ...
    echo "<script>alert('Data berhasil diperbarui!'); window.location='dataagama.php';</script>";
}
?>
...
<html lang="en">
  ...
  <head>
    ...
    <title>AdminSekolah | Form Edit Data Agama</title>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Form Edit Data Agama</h3></div>
              <div class="col-sm-6">
              ...
              <div class="col-md-6">
                ...
                <div class="card card-primary card-outline mb-4">
                  ...
                  <form action="" method="post">
                    <!--begin::Body-->
                    <div class="card-body">
                      <input type="hidden" name="idagama" value="<?php echo $data['idagama']; ?>">
                      <div class="mb-3">
                        <label for="namaagama" class="form-label">Jurusan</label>
                        <input type="text" class="form-control" id="namagama" name="namaagama" value="<?php echo $data['namaagama']; ?>"/>
                      </div>
                    </div>
                    <!--end::Body-->
                    <!--begin::Footer-->
