...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="progress-group">
                                        <span class="progress-text">Data Agama</span>
                                        <span class="float-end"><b><?php echo $jumlahdata_agama; ?></b>/100</span>
                                        <div class="progress progress-sm">
                                            <div class="progress-bar text-bg-success" style="width: <?php echo ($jumlahdata_agama / 100) * 100; ?>%"></div>
                                        </div>
                                        </div>
                                        <div class="progress-group">
                                        Data Users
                                        <span class="float-end"><b><?php echo $jumlahdata_user; ?></b>/100</span>
                                        <div class="progress progress-sm">
                                            <div class="progress-bar text-bg-danger" style="width: <?php echo ($jumlahdata_user / 100) * 100; ?>%"></div>
                                        </div>
                                        </div>
                                    </div>
                                    <!-- /.col -->
    ...
    <script>
        ...
        const jumlahdata_agama = <?php echo $jumlahdata_agama; ?>;
        const jumlahdata_user = <?php echo $jumlahdata_user; ?>;
        const sales_chart_options = {
            series: [{
                name: 'Jumlah Data',
                data: [jumlahdata_siswa, jumlahdata_jurusan, jumlahdata_agama, jumlahdata_user],
            },],
            chart: {
                height: 180,
                type: 'area',
